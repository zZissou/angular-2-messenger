...
class _View_ErrorComponent0 extends import1.AppView<import3.ErrorComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_4,'class','modal-dialiog');
    ...
    this.renderer.setElementAttribute(this._el_8,'clas','modal-header');
    ...
    this._el_13 = this.renderer.createElement(this._el_8,'h4',(null as any));
    this.renderer.setElementAttribute(this._el_13,'class','modal-title');
    ...
    this._el_17 = this.renderer.createElement(this._el_6,'div',(null as any));
    this.renderer.setElementAttribute(this._el_17,'class','modal-body');
    ...
    this.renderer.setElementAttribute(this._el_23,'class','modal-footer');
    this._text_24 = this.renderer.createText(this._el_23,'\n        ',(null as any));
    this._el_25 = this.renderer.createElement(this._el_23,'button',(null as any));
    this.renderer.setElementAttribute(this._el_25,'class','btn btn-default');
    this.renderer.setElementAttribute(this._el_25,'type','button');
    this._text_26 = this.renderer.createText(this._el_25,'Close',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import11.NgStyle) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 30)))) { return this._NgStyle_2_3; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
  ...
  private _handle_click_10_0($event:any):boolean {
    ...
    const pd_0:any = ((<any>this.context.onErrorHandles()) !== false);
    return (true && pd_0);
  }
...
export function viewFactory_ErrorComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.ErrorComponent> {
  if ((renderType_ErrorComponent === (null as any))) { (renderType_ErrorComponent = viewUtils.createRenderComponentType('/Users/zZissou/wdi/angular-2-messenger/assets/app/errors/error.component.html',0,import9.ViewEncapsulation.Emulated,styles_ErrorComponent,{})); }
